# Contributing to Agash.Webhook.Abstractions
...
```bash
dotnet restore Agash.Webhook.Abstractions.slnx
dotnet build Agash.Webhook.Abstractions.slnx
...
```bash
dotnet test Agash.Webhook.Abstractions.slnx --filter "TestCategory!=Integration"
```
